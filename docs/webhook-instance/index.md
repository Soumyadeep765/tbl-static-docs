...
**Webhooks** are signed HTTP endpoints that trigger TBL commands from external systems — websites, cron jobs, payment providers, or your own backend.
...
## Webhook vs Webapp vs Public Web
...
Webhook commands receive the full TBL sandbox except `msg`:
